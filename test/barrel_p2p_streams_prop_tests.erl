...
%%%
%%% Property tests for barrel_p2p_streams.
%%%
...
-module(barrel_p2p_streams_prop_tests).
...
setup() ->
    ...
    {ok, _} = barrel_p2p_streams:start_link(),
    ok.
...
check_dispatch(Tag, Payload, Chunks) ->
    ...
    Self = self(),
    drain(),
    ok = barrel_p2p_streams:unregister_acceptor(Tag),
    ok = barrel_p2p_streams:register_acceptor(Tag, Self),
