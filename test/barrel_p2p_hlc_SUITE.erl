...
test_now_returns_timestamp(_Config) ->
    #timestamp{wall_time = Wall, logical = Logical} = barrel_p2p_hlc:now(),
...
test_now_advances(_Config) ->
    ...
    ?assertEqual(gt, barrel_p2p_hlc:compare(T2, T1)),
    ok.
