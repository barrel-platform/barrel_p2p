%%% -*- erlang -*-
%%%
%%% Barrel P2P Path Stats
%%%
%%% Thin accessor over upstream `quic:get_path_stats/1' for the
%%% per-peer dist QUIC connection. Used by `barrel_p2p_router' to
%%% rank candidate next-hops by srtt.
%%%
%%% Copyright (c) 2026 Benoit Chesneau
%%% Apache License 2.0

-module(barrel_p2p_path_stats).
...
%% Used by `summary/1' here and by `barrel_p2p:migrate_peer/1,2' for
...
%% making barrel_p2p depend on the internal record header.
