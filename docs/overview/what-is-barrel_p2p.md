...
Barrel P2P is a peer-to-peer distribution layer for Erlang/OTP. It
...
Visually, this is the shape of a barrel_p2p cluster from one node's
point of view:
...
|------------|-------------------|--------------------|
| `-proto_dist barrel_p2p` boot flag | Drop-in replacement for the default dist | [Dist channel concept](../concepts/dist-channel.md) |
